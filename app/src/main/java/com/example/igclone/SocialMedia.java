...
public class SocialMedia extends AppCompatActivity {
   ...
   private TabAdapter tabAdapter;
    ...
    @Override
    public boolean onCreateOptionsMenu(Menu menu) {  //method use to inflate the Menu Button
    ...
    @Override
    public boolean onOptionsItemSelected(@NonNull MenuItem item) { //permissions for camera button in tool bar to access image gallery

        if (item.getItemId() == R.id.postImageItem){



            if (android.os.Build.VERSION.SDK_INT >= 23 && ActivityCompat.checkSelfPermission(SocialMedia.this,
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 4000 && resultCode == RESULT_OK && data != null){
            try {
                ...
                final ProgressDialog dialog = new ProgressDialog(SocialMedia.this);
